function ThirdQuery_Dipht(){
  ...
  var svg = d3.select("#ThirdQ_Dipht_LineChart")
    .append("svg")
  ...
  d3.csv("./LineCharts/ThirdQuery_LineChart.csv", function(data) {
      ...
      d3.select("#selectButton_TQ_Dipht_LineChart")
        .selectAll('myOptions')
        .data(allGroup)
        .enter()
        .append('option')
  ...
  */
      ...
      var yy = d3.scaleLinear()
        .domain([0, d3.max(data, function(d) { return +d.Diphtheria; })])
        .range([ height, 0 ]);
  ...
  */
      ...
      var line2 = svg
        ...
        .append("path")
          ...
          .attr("d", d3.line()
            .x(function(d) { return x(d.Year) })
            .y(function(d) { return yy(+d.Diphtheria) })
          )
      ...
      d3.select("#selectButton_TQ_Dipht_LineChart").on("change", function(d) {
