function LastQuery_AM(){
  ...
  var svg = d3.select("#LastQ_AM_LineChart")
    .append("svg")
  ...
  d3.csv("./LineCharts/LastQuery_LineChart.csv", function(data) {
      ...
      d3.select("#selectButton_TQ_AM_LineChart")
        .selectAll('myOptions')
        .data(allGroup)
        .enter()
        .append('option')
  ...
  */
      ...
      var yy = d3.scaleLinear()
        .domain([0, d3.max(data, function(d) { return +d.AdultMortality; })])
        .range([ height, 0 ]);
  ...
  */
      svg.append("g")
        ...
        svg.append("text")
                    ...
                    .attr("y", 40)
                    .text("Adult mortality (per 1000 population)");
      ...
      var line2 = svg
        ...
        .append("path")
          ...
          .attr("d", d3.line()
            .x(function(d) { return x(d.Year) })
            .y(function(d) { return yy(+d.AdultMortality) })
          )
      ...
      d3.select("#selectButton_TQ_AM_LineChart").on("change", function(d) {
