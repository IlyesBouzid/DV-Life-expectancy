function FourthQuery_Expend(){
  ...
  var svg = d3.select("#FourthQ_Expend_LineChart")
    .append("svg")
  ...
  d3.csv("./LineCharts/FourthQuery_LineChart.csv", function(data) {
      ...
      d3.select("#selectButton_TQ_Expend_LineChart")
        .selectAll('myOptions')
        .data(allGroup)
        .enter()
        .append('option')
  ...
  */
      svg.append("g")
        ...
        // Add Y right axis
      var yy = d3.scaleSqrt()
        .domain([0, d3.max(data, function(d) { return +d.percentageExpenditure; })])
        .range([ height, 0 ]);
  ...
  */
      ...
      var line2 = svg
        ...
        .append("path")
          ...
          .attr("d", d3.line()
            .x(function(d) { return x(d.Year) })
            .y(function(d) { return yy(+d.percentageExpenditure) })
          )
      ...
      d3.select("#selectButton_TQ_Expend_LineChart").on("change", function(d) {
